...
1. Create an array to store the following words: firetruck, fire drill, fire hydrant, firefighter, fireproof, fire station, fire hose. Print out all the elements of the array, with "fire" removed. Note: Your array should still contain all the starting words with _fire_.
